...
from stable_baselines3.td3.cliptd3 import ClipTD3

SelfClipDDPG = TypeVar("SelfClipDDPG", bound="ClipDDPG")


class ClipDDPG(ClipTD3):
    """
    ---
    NOTE: Nikasha modified the original code to include clipping the gradients
    ---
    ...
    :param clip_val: the max magnitude of the gradients in the actor network.
